...
public class GenericIcebergDataReader extends AbstractIcebergDataReader<Record> {
  ...
  @Override
  protected Function<MessageType, ParquetValueReader<?>> getParquetReaderFunction(Schema projectedSchema,
  ...
  @Override
  protected Function<TypeDescription, OrcRowReader<?>> getOrcReaderFunction(Schema projectedSchema,
      Map<Integer, ?> idToConstant) {
    return fileSchema -> GenericOrcReader.buildReader(projectedSchema, fileSchema, idToConstant);
  }
